...
public class WeightAdapter extends ArrayAdapter{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView _date = _weightItem.findViewById(R.id.weight_history_item_date);
        TextView _weight = _weightItem.findViewById(R.id.weight_history_item_weight);

        Weight _row = weights.get(position);
        _date.setText(_row.getDate());
        String weight = Integer.toString(_row.getWeight());
